...
const zh = {
  ...
  'result.clearFilters': '清除全部筛选',
  'result.filterOperator': '{column} 的筛选运算符',
  'result.filterValue': '{column} 的筛选值',
  'result.clearColumnFilter': '清除 {column} 筛选',
  'result.filters': '筛选',
  'result.sorts': '排序',
  'result.clearAllCriteria': '清除全部筛选和排序',
  'result.removeCriterion': '移除条件',
  'result.filterBuilder': '筛选条件',
  'result.sortBuilder': '排序条件',
  'result.match': '匹配',
  'result.matchAll': '全部条件 AND',
  'result.matchAny': '任一条件 OR',
  'result.filterColumn': '筛选字段',
  'result.filterColumnAction': '筛选 {column}',
  'result.value': '值',
  'result.addCondition': '添加条件',
  'result.closeBuilder': '关闭条件面板',
  'result.sortColumn': '排序字段',
  'result.sortDirection': '排序方向',
  'result.ascending': '升序',
  'result.descending': '降序',
  'result.moveUp': '提高排序优先级',
  'result.moveDown': '降低排序优先级',
  'result.addSort': '添加排序',
  'result.clearSorts': '清除排序',
  'result.applySorts': '应用排序',
  'result.sortHint': '点击排序；Shift 点击添加多列排序',
  'operator.eq': '等于',
  'operator.neq': '不等于',
  ...
  'details.unique': '唯一',
  'details.primary': '主键',
  'details.product': '数据库产品',
  'details.version': '服务器版本',
  'details.charset': '字符集',
  'details.collation': '排序规则',
  'details.constraints': '约束',
  ...
  'field.tags': '标签',
  'field.tags.placeholder': '使用逗号分隔标签',
  'field.versionHint': '版本提示',
  'action.cancel': '取消',
  'action.save': '保存',
  'action.test': '测试连接',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'result.clearFilters': 'Clear all filters',
  'result.filterOperator': 'Filter operator for {column}',
  'result.filterValue': 'Filter value for {column}',
  'result.clearColumnFilter': 'Clear filter for {column}',
  'result.filters': 'Filter',
  'result.sorts': 'Sort',
  'result.clearAllCriteria': 'Clear all filters and sorts',
  'result.removeCriterion': 'Remove criterion',
  'result.filterBuilder': 'Filter criteria',
  'result.sortBuilder': 'Sort criteria',
  'result.match': 'Match',
  'result.matchAll': 'All conditions (AND)',
  'result.matchAny': 'Any condition (OR)',
  'result.filterColumn': 'Filter column',
  'result.filterColumnAction': 'Filter {column}',
  'result.value': 'Value',
  'result.addCondition': 'Add condition',
  'result.closeBuilder': 'Close criteria panel',
  'result.sortColumn': 'Sort column',
  'result.sortDirection': 'Sort direction',
  'result.ascending': 'Ascending',
  'result.descending': 'Descending',
  'result.moveUp': 'Increase sort priority',
  'result.moveDown': 'Decrease sort priority',
  'result.addSort': 'Add sort',
  'result.clearSorts': 'Clear sorts',
  'result.applySorts': 'Apply sorts',
  'result.sortHint': 'Click to sort; Shift-click for multi-column sorting',
  'operator.eq': 'Equals',
  ...
  'details.version': 'Server version',
  'details.charset': 'Character set',
  ...
  'field.tags': 'Tags',
  'field.tags.placeholder': 'Separate tags with commas',
  'field.versionHint': 'Version hint',
